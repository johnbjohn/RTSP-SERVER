...
#define RTSP_BUFFERSIZE 8096
#define MAX_DESCR_LENGTH 8096
...
typedef unsigned int (*RTP_play_action)(unsigned int u32Rtp, unsigned char *pData, int s32DataSize, unsigned int u32TimeStamp);
...
typedef struct _schedule_list
{
	...
	int BeginFrame;
	RTP_session *rtp_session;/*RTP会话*/
	RTP_session *rtp_session_audio;/*RTP会话*/	
